...
export const items: Item[] = [
  {
    ...
    author: {
      avatar: `${appConfig.baseUrl}/assets/avatars/avatar-alcides-antonio.png`,
    ...
    shared: [
      {
        avatar: `${appConfig.baseUrl}/assets/avatars/avatar-anika-visser.png`,
        name: 'Anika Visser',
      },
      {
        avatar: `${appConfig.baseUrl}/assets/avatars/avatar-miron-vitold.png`,
        name: 'Miron Vitold',
      }
    ],
    size: 528381242,
  ...
  },
  {
    ...
    author: {
      avatar: `${appConfig.baseUrl}/assets/avatars/avatar-fran-perez.png`,
      name: 'Fran Perez',
    },
  ...
  },
  {
    ...
    shared: [
      ...
      {
        avatar: `${appConfig.baseUrl}/assets/avatars/avatar-nasimiyu-danai.png`,
        name: 'Nasimiyu Danai'
      },
    ],
    size: 194220900,
  ...
  },
  {
    ...
    author: {
      avatar: `${appConfig.baseUrl}/assets/avatars/avatar-carson-darrin.png`,
      name: 'Carson Darrin'
    },
  ...
  },
  {
    ...
    author: {
      avatar: `${appConfig.baseUrl}/assets/avatars/avatar-siegbert-gottfried.png`,
  ...
  },
  {
    ...
    shared: [
      {
        avatar: `${appConfig.baseUrl}/assets/avatars/avatar-iulia-albu.png`,
        name: 'Iulia Albu'
      }
    ],
    size: 746826456,
  ...
  },
  {
    ...
    author: {
      avatar: `${appConfig.baseUrl}/assets/avatars/avatar-marcus-finn.png`,
      name: 'Marcus Finn'
    },
  ...
  },
  {
    ...
    author: {
      avatar: `${appConfig.baseUrl}/assets/avatars/avatar-omar-darboe.png`,
      name: 'Omar Darobe'
    },
  ...
  },
  {
    ...
    author: {
      avatar: `${appConfig.baseUrl}/assets/avatars/avatar-penjani-inyene.png`,
      name: 'Penjani Inyene'
    },
  ...
  },
  {
    ...
    author: {
      avatar: `${appConfig.baseUrl}/assets/avatars/avatar-jie-yan-song.png`,
      name: 'Jie Yan Song'
    },
  ...
  },
  {
    ...
    shared: [
      {
        avatar: `${appConfig.baseUrl}/assets/avatars/avatar-neha-punita.png`,
        name: 'Neha Punita'
      }
    ],
    size: 528228820,
  ...
  },
  {
    ...
    shared: [
      {
        avatar: `${appConfig.baseUrl}/assets/avatars/avatar-cao-yu.png`,
        name: 'Cao Yu'
      },
      {
        avatar: `${appConfig.baseUrl}/assets/avatars/avatar-siegbert-gottfried.png`,
