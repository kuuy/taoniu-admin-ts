...
export const companies: Company[] = [
  {
    ...
    logo: `${appConfig.baseUrl}/assets/companies/company-logo-1.svg`,
    name: 'Augmastic Inc.',
  ...
  },
  {
    ...
    logo: `${appConfig.baseUrl}/assets/companies/company-logo-2.svg`,
  ...
  },
  {
    ...
    logo: `${appConfig.baseUrl}/assets/companies/company-logo-3.svg`,
    name: 'Talkster Inc.',
  ...
  },
  {
    ...
    logo: `${appConfig.baseUrl}/assets/companies/company-logo-4.svg`,
    name: 'Devias IO SRL',
  ...
  assets: [
    {
      ...
      size: '23 Kb',
      url: `${appConfig.baseUrl}/assets/covers/abstract-2-4x4-small.png`
    },
    {
...
Our mission emphasizes seeking and hiring diverse voices, including those who are traditionally underrepresented in the technology industry, and we consider this to be one of the most important values we hold close. We're a hard-working, fun, and exciting group who value intellectual curiosity and a passion for problem-solving! We have growing offices located in San Francisco, Sunnyvale, Bellevue, Los Angeles, Tokyo, Hamburg, London, and Zurich.`,
  ...
  images: [
    `${appConfig.baseUrl}/assets/gallery/gallery-1.jpg`,
    `${appConfig.baseUrl}/assets/gallery/gallery-2.jpg`,
    `${appConfig.baseUrl}/assets/gallery/gallery-3.jpg`,
    `${appConfig.baseUrl}/assets/gallery/gallery-4.jpg`,
    `${appConfig.baseUrl}/assets/gallery/gallery-5.jpg`,
    `${appConfig.baseUrl}/assets/gallery/gallery-6.jpg`
  ],
  isVerified: true,
  jobs: [
    {
