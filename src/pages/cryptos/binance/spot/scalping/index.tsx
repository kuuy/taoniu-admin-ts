...
import {ScalpingContainer} from '~/src/sections/binance/spot/scalping/scalping-container'
import {ScalpingListTable} from '~/src/sections/binance/spot/scalping/scalping-list-table'
import {ScalpingListSearch} from '~/src/sections/binance/spot/scalping/scalping-list-search'
import PlusIcon from '@untitled-ui/icons-react/build/esm/Plus'
import {useMounted} from '~/src/hooks/use-mounted'
import {scalpingApi} from '~/src/api/cryptos/binance/spot/scalping'
import {Scalping} from '~/src/types/binance/spot/scalping'
...
const Page:NextPageWithLayout = () => {
  ...
  const { scalping } = useListings(search)
  ...
  return (
    <>
      <Head>
        <title>
          Dashboard: Scalping List | Devias Kit PRO
        </title>
      </Head>
      <Divider />
      <Box
