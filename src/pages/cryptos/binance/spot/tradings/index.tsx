...
import {indicatorsApi} from '~/src/api/cryptos/binance/spot/indicators'
...
const Page:NextPageWithLayout = () => {
  ...
  const tradingViewProps: Partial<TradingViewProps> = {
    ...
    locale: "en",
    datafeed_url: "/api/cryptos/v1/binance/spot/tradingview/datafeed",
    fullscreen: false,
    autosize: true,
      ...
      >
        ...
        >
          ...
          <TradingDrawer
            ...
            open={drawer.isOpen}
            trading={currentTrading as Trading}
          />
        </Box>
      </Box>
    </>
