  ...
  return [
    {
      ...
      duration: '78 hours',
      media: `${appConfig.baseUrl}/assets/courses/course-1.png`,
      progress: 23,
    ...
    },
    {
      ...
      description: 'Introductory course for design and framework basics',
      duration: '14 hours',
      media: `${appConfig.baseUrl}/assets/courses/course-2.png`,
      progress: 52,
    ...
    },
    {
      ...
      description: 'Introductory course for design and framework basics',
      duration: '21 hours',
      media: `${appConfig.baseUrl}/assets/courses/course-3.png`,
      progress: 90,
