...
const issuers: Record<Issuer, string> = {
  // Amplify: `${appConfig.baseUrl}/assets/logos/logo-amplify.svg`,
  // Auth0: `${appConfig.baseUrl}/assets/logos/logo-auth0.svg`,
  // Firebase: `${appConfig.baseUrl}/assets/logos/logo-firebase.svg`,
  JWT: `${appConfig.baseUrl}/assets/logos/logo-jwt.svg`,
}
