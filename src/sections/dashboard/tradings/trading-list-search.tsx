...
interface TradingListSearchProps {
...
export const TradingListSearch: FC<TradingListSearchProps> = (props) => {
      ...
      >
        ...
        >
          <OutlinedInput
            ...
            name="tradingNumber"
            placeholder="Search by trading number"
            startAdornment={(
